<shader file="src/post/tonemap.hlsl" provider="PbrEnvironmentProvider">

<techniques>
	<techique name="avgLum">
		...
		<PS entryPoint="PS_avgLum" shaderModel="ps_4_0">
			<Defines>
	...
	<techique name="downsample">
		...
		<PS entryPoint="PS_downsample" shaderModel="ps_4_0">
			<Defines>
				<item name="DEFINE_NAME" val="DEFINE_VALUE"/>
			</Defines>
	...
	<techique name="tonemap">
		...
		<PS entryPoint="PS_tonemap" shaderModel="ps_4_0">
			<Defines>
				<item name="DEFINE_NAME" val="DEFINE_VALUE"/>
			</Defines>
