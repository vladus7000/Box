<shader file="src/skybox.hlsl" provider="DefaultShaderEnvironmentProvider">
...
<techniques>
	<techique name="t1">
		<VS entryPoint="t1_VsMain" shaderModel="vs_4_0">
			...
			<InputLayout>
				<item semanticName="Position" semanticIndex="0" stream="0" format="Float4"/>
			</InputLayout>
		...
		<PS entryPoint="t1_psMain" shaderModel="ps_4_0">
			...
			<DepthStencil>
				...
				<item name="DepthFunc" value="Equal"/>
			</DepthStencil>
